...
router.get('/all-lang-questions', paidExamController.allLanguageQuestions);
...
router.post('/add-paid-exam', [
    ...
    check('part1').not().isEmpty(),
    check('part1_ar').not().isEmpty(),
    check('part1_nl').not().isEmpty(),
    check('part2').not().isEmpty(),
    check('part2_ar').not().isEmpty(),
    check('part2_nl').not().isEmpty(),
    check('part3').not().isEmpty(),
    check('part3_ar').not().isEmpty(),
    check('part3_nl').not().isEmpty(),
...
router.patch('/replace-question/:examId', [
    check('question_id').not().isEmpty(),
    check('new_question_id').not().isEmpty(),
    check('question_img').not().isEmpty(),
    check('question').not().isEmpty(),
    check('question_ar').not().isEmpty(),
    check('question_nl').not().isEmpty(),
    check('answer').not().isEmpty(),
    ...
    check('reason_ar').not().isEmpty(),
    check('reason_nl').not().isEmpty(),
], paidExamController.replaceQuestion);
